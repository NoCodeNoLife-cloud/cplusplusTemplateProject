 ...
 * @details Verifies shortest distances: 0→1 (2) + 1→2 (3) = 5
 */
 ...
 * @details Verifies that Dijkstra finds the optimal path 0→1→2→3 (total 4)
 *          over the more direct but expensive 0→2→3 path
 */
