...
TEST_F(FileTest, GetAbsolutePath)
{
    ...
    File f("abs_path.txt"); // relative path
...
{
    File a(tmpDir_ / "hash.txt");
    File b(tmpDir_ / "hash.txt");
