 ...
 */
class ClassToolkitTest : public testing::Test
{
protected:
    void SetUp() override
    {
 ...
 */
TEST_F(ClassToolkitTest, GetTypeId_BasicTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeId_CustomClass)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdWithCvr_BasicTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdByClass_IntType)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdByClass_DoubleType)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdByClass_StringType)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdByClass_CustomClass)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdWithCvrByClass_ConstInt)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeIdWithCvrByClass_VolatileDouble)
{
 ...
 */
TEST_F(ClassToolkitTest, Consistency_ByClassVsByObject)
{
 ...
 */
TEST_F(ClassToolkitTest, Consistency_CvrMethods)
{
 ...
 */
TEST_F(ClassToolkitTest, GetFields_BasicStructure)
{
 ...
 */
TEST_F(ClassToolkitTest, GetFields_EmptyString)
{
 ...
 */
TEST_F(ClassToolkitTest, GetFields_NegativeValues)
{
 ...
 */
TEST_F(ClassToolkitTest, ConstructorDeleted)
{
 ...
 */
TEST_F(ClassToolkitTest, IsSameType_IdenticalTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsSameType_DifferentTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsBaseOf_ValidInheritance)
{
    struct Base
    {
    };
 ...
 */
TEST_F(ClassToolkitTest, IsBaseOf_NoInheritance)
{
    struct ClassA
    {
    };
 ...
 */
TEST_F(ClassToolkitTest, IsPolymorphic_PolymorphicClass)
{
    struct Polymorphic
    {
 ...
 */
TEST_F(ClassToolkitTest, IsPolymorphic_NonPolymorphicClass)
{
 ...
 */
TEST_F(ClassToolkitTest, IsAbstract_AbstractClass)
{
    struct Abstract
    {
        virtual void foo() = 0;
 ...
 */
TEST_F(ClassToolkitTest, IsAbstract_ConcreteClass)
{
    struct Concrete
    {
        void foo()
 ...
 */
TEST_F(ClassToolkitTest, GetTypeSize_BasicTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeSize_CustomStruct)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeAlignment_BasicTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsDefaultConstructible_ConstructibleTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsCopyConstructible_CopyableTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsMoveConstructible_MovableTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsTriviallyCopyable_TrivialTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, IsTriviallyDestructible_TrivialTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeHash_ConsistentValues)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeHash_DifferentTypes)
{
 ...
 */
TEST_F(ClassToolkitTest, GetFieldNames_ReturnsAllFields)
{
 ...
 */
TEST_F(ClassToolkitTest, GetFieldCount_ReturnsCorrectCount)
{
 ...
 */
TEST_F(ClassToolkitTest, GetFieldByName_RetrievesCorrectValue)
{
    const TestPerson person{"Alice", 25, 95.5};
 ...
 */
TEST_F(ClassToolkitTest, GetFieldByName_InvalidFieldName_ThrowsException)
{
    const TestPerson person{"Bob", 30, 88.5};
 ...
 */
TEST_F(ClassToolkitTest, CompareObjects_IdenticalObjects)
{
 ...
 */
TEST_F(ClassToolkitTest, CompareObjects_DifferentObjects)
{
    const TestPerson person1{"Alice", 25, 95.5};
 ...
 */
TEST_F(ClassToolkitTest, GetObjectDiff_IdenticalObjects)
{
    const TestPerson person1{"Alice", 25, 95.5};
    const TestPerson person2{"Alice", 25, 95.5};
 ...
 */
TEST_F(ClassToolkitTest, GetObjectDiff_DifferentObjects)
{
    const TestPerson person1{"Alice", 25, 95.5};
 ...
 */
TEST_F(ClassToolkitTest, GetObjectDiff_PartiallyDifferent)
{
    const TestPerson person1{"Alice", 25, 95.5};
 ...
 */
TEST_F(ClassToolkitTest, GetTypeInfo_ComprehensiveInformation)
{
 ...
 */
TEST_F(ClassToolkitTest, GetTypeInfo_CustomClass)
{
