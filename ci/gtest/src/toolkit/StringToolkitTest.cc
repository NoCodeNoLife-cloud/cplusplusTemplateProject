...
/**
 * @brief Test split by string delimiter — basic case
 ...
 * @details Verifies idempotency — uppercase input yields same output
 */
 ...
 * @details Verifies idempotency — lowercase input yields same output
 */
