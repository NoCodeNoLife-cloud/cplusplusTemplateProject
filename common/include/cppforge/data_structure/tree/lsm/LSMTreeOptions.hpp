 ...
 *
 * @par Thread Safety
 * Options are read after construction and never modified ¡ª no synchronisation
...
namespace cppforge::data_structure::tree::lsm
{
    ...
    ///   - Each level is @p fanOut (¡Á10) larger than the previous
    ...
    struct LSMTreeOptions final
    {
        ...
        ///
        /// Level (i+1) is allowed to hold up to @p fanOut ¡Á the target size
