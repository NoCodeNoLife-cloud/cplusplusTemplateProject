...
namespace cppforge::thread
{
    ...
    public:
        ...
        explicit PeriodicActuator(std::shared_ptr<interface::task::ITimerTask> task, std::chrono::milliseconds interval);
    ...
    private:
        ...
        std::shared_ptr<interface::task::ITimerTask> task_{};
