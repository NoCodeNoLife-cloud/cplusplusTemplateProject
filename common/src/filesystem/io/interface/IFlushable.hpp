 ...
 * @details This header defines the IFlushable class that provides functionality for Common library utilities.
 */
...
namespace common::interfaces
{
    ...
    public:
        ...
        [[nodiscard]] virtual bool isFlushNeeded() const;
    ...
    inline bool IFlushable::isFlushNeeded() const
    {
